    ...
    <div className="your-panel">
      ...
      <header className="dashboard-header">
        ...
        <nav className="nav-tabs">
          <NavLink to="/student-dashboard" className={({ isActive }) => isActive ? "nav-link active-link" : "nav-link"}>Dashboard</NavLink>
          <NavLink to="/student-events" className={({ isActive }) => isActive ? "nav-link active-link" : "nav-link"}>Events</NavLink>
        </nav>
        <div className="icons">
